...
export const scrollChainAbi: Array<JsonFragment> = [
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_parentBatchHeader', type: 'bytes' },
      { internalType: 'bytes[]', name: '_chunks', type: 'bytes[]' },
      { internalType: 'bytes', name: '_skippedL1MessageBitmap', type: 'bytes' },
    ],
    name: 'commitBatch',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'bytes', name: '_batchHeader', type: 'bytes' },
      { internalType: 'bytes32', name: '_prevStateRoot', type: 'bytes32' },
      { internalType: 'bytes32', name: '_postStateRoot', type: 'bytes32' },
      { internalType: 'bytes32', name: '_withdrawRoot', type: 'bytes32' },
    ],
    name: 'finalizeBatch',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32', name: '_postStateRoot', type: 'bytes32' },
      { internalType: 'bytes32', name: '_withdrawRoot', type: 'bytes32' },
      { internalType: 'bytes', name: '_aggrProof', type: 'bytes' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_messageQueue', type: 'address' },
      { internalType: 'address', name: '_verifier', type: 'address' },
      { internalType: 'uint256', name: '_maxNumTxInChunk', type: 'uint256' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_batchIndex', type: 'uint256' }],
...
export const abi: Array<JsonFragment> = [
  {
    inputs: [
